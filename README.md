...
- Inventory
- Save / load
- UI and gameplay state

### VALORANT — Tactical FPS

- Round state and match flow
- Weapon interactions
...
**Testing:** Functional • Exploratory • Smoke • Regression • Compatibility • Performance • Network • Accessibility

**Game QA:** Gameplay systems • Quest progression • Combat • Vehicles • UI • AI • Save/load • Match flow • Mobile lifecycle

**Documentation:** Bug reports • Test cases • Test plans • Checklists • Test execution reports • Bug triage

**QA Thinking:** Reproduction • Risk identification • Boundary testing • Recovery testing • Cross-platform considerations
